...
let STORE_ITEMS_SCREEN_FIXTURE = Store(items: ITEMS_FIXTURE, selectedItem: nil, alertVisible: false, alertTitle: "")
let STORE_ITEM_SCREEN_FIXTURE = Store(items: ITEMS_FIXTURE, selectedItem: ITEM_FIXTURE, alertVisible: false, alertTitle: "")
